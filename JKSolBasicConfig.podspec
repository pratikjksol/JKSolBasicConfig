...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of JKSolBasicConfig.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jksol/JKSolBasicConfig'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jksol' => 'jksol.com' }
  s.source           = { :git => 'https://github.com/jksol/JKSolBasicConfig.git', :tag => s.version.to_s }
